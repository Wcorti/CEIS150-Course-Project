...
#create Retirement_Account class (parent class)
class Retirement_Account:
    def __init__(self, balance, number):
        self.balance = balance
        self.number = number

#create Traditional account (child class)
class Traditional(Retirement_Account):
    def __init__(self, balance, number):
        Retirement_Account.__init__(self, balance, number) #parent constructor
        self.Stock_List = []

    def add_stock(self, stock_data):
        self.Stock_List.append(stock_data)

#create Robo account (child class)
class Robo(Retirement_Account):
    ...
    def investment_return(self):
        return (self.years*self.balance*1.05) #calculates account balance after x ammount of years with a 5 precent return on investment
